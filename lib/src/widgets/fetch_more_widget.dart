...
class FetchMoreIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CustomRefreshIndicator(
      onRefresh: () async => isLastPage
          ? Future<void>.delayed(const Duration(seconds: 0, milliseconds: 500))
          : onAction(),
                        ...
                        children: [
                          if (isLastPage)
                            /*  Container(
                              ...
                              width: 16,
                              height: 16,
                              child: const Icon(Icons.ac_unit_sharp,color: AppColors.darkestGrey,),
                            )*/
                            Container(
                              margin: const EdgeInsets.only(bottom: 8.0),
                              width: 16,
