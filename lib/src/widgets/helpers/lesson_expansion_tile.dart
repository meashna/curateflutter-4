...
/// [LessonExpansionTile] to save and restore its expanded state when it is scrolled
/// in and out of view.
///
...
/// to the [leading] and [trailing] properties of [LessonExpansionTile].
///
/// {@tool dartpad}
...
class LessonExpansionTile extends StatefulWidget {
  ...
  @override
  State<LessonExpansionTile> createState() => _LessonExpansionTileState();
}

class _LessonExpansionTileState extends State<LessonExpansionTile>
  ...
  Widget? _buildIcon(BuildContext context) {
    return RotationTransition(
      turns: _iconTurns,
      child: Icon(
        _isExpanded ? Icons.clear : Icons.expand_more,
        size: 12.sps,
      ),
    );
  }
  ...
  Widget? _buildTrailingIcon(BuildContext context) {
    ...
    return Container(
        ...
        decoration: BoxDecoration(
            color: AppColors.round_icon_bg_color, shape: BoxShape.circle),
      ...
      child: Column(
        ...
        children: <Widget>[
          Container(
            ...
            padding: EdgeInsets.symmetric(horizontal: 20.sps, vertical: 12.sps),
            child: Row(
              ...
              children: [
                Expanded(
                  ...
                  children: [
                    ...
                    widget.subtitle == null ? Container() : widget.subtitle!,
                  ],
                )),
                GestureDetector(
                    onTap: _handleTap,
          ...
          ClipRect(
            child: Card(
              ...
              shape: RoundedRectangleBorder(
                borderRadius: BorderRadius.circular(8.0.sps),
              ),
              margin: !_isExpanded
                  ? EdgeInsets.symmetric(horizontal: 0.sps, vertical: 0.sps)
                  : EdgeInsets.symmetric(horizontal: 20.sps, vertical: 12.sps),
              child: Padding(
                padding: !_isExpanded
                    ? EdgeInsets.symmetric(horizontal: 0.sps, vertical: 0.sps)
                    : EdgeInsets.symmetric(horizontal: 10.sps, vertical: 8.sps),
                child: Align(
